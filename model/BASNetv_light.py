...
class BASNet(nn.Module):
    def __init__(self,n_channels,n_classes, res = False, seg = False):
        ...
        self.conv512_1 = nn.Conv2d(1024,512,3,padding=1) # 128
        self.conv256_1 = nn.Conv2d(512,256,3,padding=1)
...
class BBnet(nn.Module):
    def __init__(self,in1_chs=3,in1_out=3,in2_chs=4,in2_out=3,seg = False):
